    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                ?>
                  <form action="deneyaplar.php?action=editPost&id=<?=$deneyap->id?>" method="post">
                ...
                <?
                  ...
                  ?>
                    <form action="deneyaplar.php?action=addPost" method="post">
                      <div class="form-group">
                        <label for="link">Adı :</label>
                  ...
                  <div class="row">
                      <div class="col-sm-12">
                          <div class="white-box">
                              ...
                              <a href="deneyaplar.php?action=add">Yeni Ekle</a>
                                      ...
                                      <tbody>
                                          <?php
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="deneyaplar.php?action=edit&id=<?=$deneyap->id?>">Düzenle</a>
                                                </td>
                                            </tr>
                                          <?
                                            }
